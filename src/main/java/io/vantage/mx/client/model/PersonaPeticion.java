package io.vantage.mx.client.model;

import java.util.Objects;
import com.google.gson.annotations.SerializedName;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;
import io.vantage.mx.client.model.CatalogoEstadoCivil;
import io.vantage.mx.client.model.CatalogoResidencia;
import io.vantage.mx.client.model.CatalogoSexo;
...
public class PersonaPeticion {
  ...
  @ApiModelProperty(example = "1978-03-23", required = true, value = "Fecha de nacimiento de la persona, en el formato especificado (por defecto dd-MM-yyyy)")
